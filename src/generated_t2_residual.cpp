...
TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> whole_t2_residual(const TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy>& C_μ̃_ap1, const TA::TSpArrayD& g_i_μ̃_Κ, const TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy>& t_ap1_i, const TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy>& C_ap2_μ̃, const TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy>& C_μ̃_ap2, const TA::TSpArrayD& g_μ̃_μ̃_Κ, const TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy>& t_ap2_ap2_i_i, const TA::TSpArrayD& s_μ̃_μ̃, const TA::TSpArrayD& g_i_i_Κ, const TA::TSpArrayD& f_i_μ̃, const TA::TSpArrayD& g_μ̃_i_Κ, const TA::TSpArrayD& f_i_i, const TA::TSpArrayD& f_μ̃_μ̃) {
  TA::TSpArrayD CSE1_Κ;
  TA::TSpArrayD I_i_μ̃;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> I_ap2_ap2;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> I_ap2_μ̃;
  ...
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> CSE4_i_i_i_ap2_ap2;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> CSE5_i_i_i_ap2_ap2;
  TA::TSpArrayD I_i_i;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> I2_i_i_ap2_ap2;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> CSE6_i_i_i_ap2;
  TA::TSpArrayD I2_i_μ̃;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> I_i_ap2;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> I_i_i_i_ap2;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> CSE7_i_i_i_ap2_ap2;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> I_i_ap1;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> CSE8_i_i_i_ap2_ap2;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> I_i_i_ap2_μ̃;
  TA::TSpArrayD I_i_i_μ̃_μ̃;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> CSE9_i_i_i_i_ap2_ap2;
  TA::TSpArrayD CSE10_i_i_μ̃_μ̃;
  TA::TSpArrayD I_i_i_Κ;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> CSE11_i_i_ap2_μ̃;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> I2_i_i_ap2_μ̃;
  TA::TSpArrayD CSE12_i_i_i_i;
  TA::TSpArrayD I2_i_i_Κ;
  TA::TSpArrayD CSE13_i_i_μ̃_μ̃;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> CSE14_i_i_ap2_μ̃;
  ...
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> CSE19_i_i_ap2_Κ;
  TA::TSpArrayD I_i_μ̃_Κ;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> CSE20_i_i_ap2_Κ;
  TA::TSpArrayD CSE21_i_μ̃_Κ;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> CSE22_i_i_ap2_Κ;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> I2_ap2_μ̃;
  TA::TSpArrayD I2_μ̃_μ̃;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> CSE23_i_i_i_ap2_ap2;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> I2_i_ap2_Κ;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> CSE24_i_i_i_i_ap2;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> I2_i_i_i_ap2;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> CSE25_i_i_i_i_ap2;
  TA::TSpArrayD CSE26_i_i_Κ;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> CSE27_i_i_ap2_Κ;
  TA::TSpArrayD CSE28_i_μ̃_Κ;
  TA::TSpArrayD CSE29_i_μ̃;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> CSE30_i_i_i_i_ap2;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> CSE31_i_i_i_i_ap2;
  TA::TSpArrayD CSE32_i_i_μ̃_μ̃;
  TA::TSpArrayD CSE33_i_i_i_μ̃;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> CSE34_i_i_i_ap2_μ̃;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> I3_i_i_ap2_ap2;
  TA::TSpArrayD CSE35_i_i_μ̃_μ̃;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> CSE36_i_i_i_ap2_ap2;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> CSE37_i_i_ap2_ap2_Κ;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> I_ap2_μ̃_Κ;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> I_i_i_ap2_ap2_Κ;
  TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy> I_i_i_ap2_ap2_RANKFIX1;
  ...
  I_ap2_μ̃ = TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy>();  // release
  ...
  I_ap2_ap2 = TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy>();  // release
  ...
  I2_i_i_ap2_ap2 = TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy>();  // release
  ...
  I_i_ap2 = TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy>();  // release
  ...
  I_i_i_i_ap2 = TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy>();  // release
  ...
  I_i_ap1 = TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy>();  // release
  I2_i_i_ap2_ap2("i_2,i_1,i_3;a_2,a_5") = TA::einsum(I_i_i("i_1,i_3"), CSE4_i_i_i_ap2_ap2("i_3,i_1,i_2;a_2,a_5"), "i_2,i_1,i_3;a_2,a_5")("i_2,i_1,i_3;a_2,a_5");
  I_i_i = TA::TSpArrayD();  // release
  ...
  I2_i_i_ap2_ap2 = TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy>();  // release
  I_i_i_ap2_ap2_RANKFIX1 = TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy>();  // release
  ...
  I2_i_i_ap2_μ̃ = TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy>();  // release
  ...
  I2_ap2_μ̃ = TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy>();  // release
  ...
  I2_i_ap2_Κ = TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy>();  // release
  I_i_ap2_Κ = TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy>();  // release
  ...
  I2_i_i_i_ap2 = TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy>();  // release
  I_i_i_ap2_ap2("i_1,i_2;a_1,a_2") += (TA::einsum(I_i_i_i_ap2("i_1,i_2,i_3;a_1"), CSE6_i_i_i_ap2("i_2,i_1,i_3;a_2"), "i_1,i_2;a_1,a_2")("i_1,i_2;a_1,a_2")) * (2);
  I_i_i_i_ap2 = TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy>();  // release
  ...
  I3_i_i_ap2_ap2 = TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy>();  // release
  I2_i_i_ap2_ap2("i_1,i_2,i_3;a_2,a_6") = TA::einsum(I_i_i("i_2,i_3"), CSE4_i_i_i_ap2_ap2("i_3,i_2,i_1;a_2,a_6"), "i_1,i_2,i_3;a_2,a_6")("i_1,i_2,i_3;a_2,a_6");
  I_i_i = TA::TSpArrayD();  // release
  ...
  I_ap2_μ̃_Κ = TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy>();  // release
  ...
  I_i_i_ap2_ap2_Κ = TA::DistArray<TA::Tensor<TA::ArenaTensor<double>>, TA::SparsePolicy>();  // release
